...
import 'package:adsum/presentation/pages/settings/providers/settings_viewmodel.dart';
...
class SettingsPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final asyncUser = ref.watch(settingsViewModelProvider);
    final vmNotifier = ref.read(settingsViewModelProvider.notifier);
    ...
    return Scaffold(
      ...
      body: asyncUser.when(
        data: (user) => _SettingsContent(user: user, viewModel: vmNotifier),
...
class _SettingsContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final uni = user?.universityId == null ? 'Not Connected' : 'MIT ADT University'; 
        ...
        children: [
          ...
          InkWell(
            onTap: () {
                ...
                // With MVVM, we might want the VM to handle nav or just push here since it's UI logic.
                // Keeping it simple.
          ...
          _buildSettingTile(
            ...
            trailing: Switch(
              ...
              onChanged: (val) => viewModel.updateSettings(settings.copyWith(themeMode: val ? 'DARK' : 'LIGHT')),
          ...
          _buildSettingTile(
            ...
            trailing: Switch(
              ...
              onChanged: (val) => viewModel.updateSettings(settings.copyWith(notificationsEnabled: val)),
          ...
          _buildSettingTile(
            ...
            trailing: Switch(
              value: !isGuest && settings.isPrivateMode,
              onChanged: isGuest ? null : (val) => viewModel.updateSettings(settings.copyWith(isPrivateMode: val)),
